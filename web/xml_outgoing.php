...
if($rowcount = mysqli_num_rows($callstate) == 0) {
  mysqli_query($db_conn,"INSERT INTO callstate (nst, state, remotenumber) VALUES ('$nst', 'outgoing', '$remotenumber')");
} else {
  mysqli_query($db_conn,"UPDATE callstate SET state='outgoing',remotenumber='$remotenumber' WHERE nst = '$nst'");
}
